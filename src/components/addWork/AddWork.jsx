            ...
            <div className="card-body">
                <form onSubmit={submitHandler} className="form">
                    <div className="mb-3">
                        ...
                        <input type="date" name="date" className="form-control" onChange={handleChange} value={formData.date}></input>
                    </div>
                    <div className="mb-3">
                        <select name="company" className="form-control" onChange={handleChange} value={formData.comapny}>
                        <option select disabled>--Pasirinkite klientą--</option>
                    ...
                    <div className="mb-3">
                        <select name="service" className="form-control" onChange={handleChange} value={formData.service}>
                            <option select disabled>--Pasirinkite paslaugą--</option>
                    ...
                    <div className="mb-3">
                        ...
                        <input type="time" name="from" className="form-control" onChange={handleChange} value={formData.from}></input>
                    </div>
                    <div className="mb-3">
                        <label htmlFor="from">To:</label>
                        <input type="time" name="to" className="form-control" onChange={handleChange} value={formData.to}></input>
                    </div>
                    <div className="mb-3">
                        {(id)?
